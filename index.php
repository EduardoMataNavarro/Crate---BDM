...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-4">
					<div id="categoriesBar">
						...
						<hr>
						<ul class="list-group">
							<li class="list-group-item">Lo mas vendido
								<span class="badge badge-primary badge-pill"></span>
							</li>
							<li class="list-group-item">Lo mas buscado
								<span class="badge badge-primary badge-pill"></span>
							</li>
							<li class="list-group-item">Lo mas visto
								<span class="badge badge-primary badge-pill"></span>
							</li>
									...
									<?php 
										...
										while($row = mysqli_fetch_array($query_result, MYSQLI_ASSOC)){
											echo '<li class="list-group-item">
												  <a href="searchResult.php?srch_term='.$row['nombre'].'">'.$row["nombre"].'</a>
												  </li>';
										}
										mysqli_close($db_connection);
									?>
				...
				<div class="col-8" id="sliderContainer">
					<div class="carousel slide" data-ride="carousel">
						<!-- Slides -->
  						<div class="carousel-inner">
   							<div class="carousel-item active">
    						 	<img class="d-block w-100" src="img/indexCarousel/mac.jpg" alt="First slide">
    						</div>
    						<div class="carousel-item">
      							<img class="d-block w-100" src="img/indexCarousel/watches.jpg" alt="Second slide">
    						</div>
   							<div class="carousel-item">
     							<img class="d-block w-100" src="img/indexCarousel/iphone.jpg" alt="Third slide">
    						</div>
  						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col">
					<img class="img-responsive img-thumbnail" src="img/products/hybrid-pro.jpg">
				</div>
				<div class="col">
					<img class="img-responsive img-thumbnail" src="img/products/aero-15x.jpg">
				</div>
				<div class="col">
					<img class="img-responsive img-thumbnail" src="img/products/nike-huarache.jpg">
				</div>
				<div class="col">
					<img class="image-responsive img-thumbnail" src="img/products/toyota-corolla.jpg">
				</div>
			</div>
			<br>
